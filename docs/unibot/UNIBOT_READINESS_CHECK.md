...
remaining ordered receipt-tail commits through the `0d98bc5` autonomous-loop
closure, current candidate, review gate, failed
...
`3a15aad`, `f31c122`, `a7775da`, and `0d98bc5` without needing private
context.
