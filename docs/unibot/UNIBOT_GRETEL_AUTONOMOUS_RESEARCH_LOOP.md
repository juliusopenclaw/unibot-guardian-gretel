...
- Candidate:
  ...
  `49ef7d9` as the previous readiness-surface closure for
  ...
  The candidate rotation receipt records `49ef7d9` as the previous closed
  ...
  removing the tail closure commit through `180d5c5`, or breaking its evidence
