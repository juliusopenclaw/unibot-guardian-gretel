...
- Candidate:
  ...
  receipt-binding receipt readiness receipt receipt receipt receipt closure in readiness evidence
  without authorizing
  ...
  `2e60207`, `d36dbfd`, `f966650`, and `8fab4a0`,
  review gate,
  ...
  `00fb3d9` as the previous autonomous-loop receipt closure for
  ...
  the current candidate is the readiness-surface step for that new tail. The
  candidate rotation receipt records `00fb3d9` as the previous closed
