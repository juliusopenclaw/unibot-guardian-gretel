...
- Candidate:
  ...
  receipt-binding receipt readiness receipt receipt receipt closure in readiness evidence
  without authorizing
  ...
  `37077b3` as the previous autonomous-loop receipt closure for
  ...
  candidate rotation receipt records `37077b3` as the previous closed
