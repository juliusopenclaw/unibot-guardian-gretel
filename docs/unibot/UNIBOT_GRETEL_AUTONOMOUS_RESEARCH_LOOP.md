...
- Candidate:
  ...
  receipt-binding receipt readiness receipt closure into the autonomous-loop receipt
  without authorizing
  ...
  `d36dbfd` as the previous readiness-surface closure for
  ...
  the current candidate is the receipt-binding step for that new tail. The
  candidate rotation receipt records `d36dbfd` as the previous closed
