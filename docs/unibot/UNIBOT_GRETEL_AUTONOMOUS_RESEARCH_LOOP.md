...
- Candidate:
  ...
  receipt-binding receipt readiness receipt closure in readiness evidence
  without authorizing
  ...
  `2e60207` as the previous autonomous-loop receipt closure for
  ...
  candidate rotation receipt records `2e60207` as the previous closed
