...
- Candidate:
  ...
  receipt-binding receipt readiness receipt receipt receipt closure into the autonomous-loop receipt
  without authorizing
  ...
  `8fab4a0` as the previous readiness-surface closure for
  ...
  new tail. The candidate rotation receipt records `8fab4a0` as the previous
