...
class UniBotAutonomousResearchLoopTests(unittest.TestCase):
    ...
    def test_work_queue_is_small_testable_and_harnessed(self) -> None:
        ...
        self.assertEqual(loop["next_recommended_work_id"], "autonomous_queue_readiness_rotation_receipt_gate")
        self.assertEqual(loop["receipt"]["closed_harnessed_work_items"], 109)
        ...
        self.assertEqual(
            ...
            by_id["autonomous_queue_readiness_rotation_receipt_gate"]["allowed_files"],
        )
        self.assertIn(
        ...
        self.assertEqual(
            ...
            "autonomous_queue_readiness_rotation_receipt_traceability",
        )
        ...
        self.assertEqual(loop["candidate_rotation_receipt"]["previous_closed_commit"], "497ac6f")
        self.assertEqual(
        ...
        self.assertEqual(by_id["autonomous_queue_readiness_rotation_receipt_gate"]["status"], "candidate")
        self.assertEqual(
            by_id["autonomous_queue_readiness_rotation_receipt_gate"]["review_gate"],
            "autonomous_queue_readiness_rotation_receipt_traceability",
        )
        self.assertIn(
    ...
    def test_markdown_and_api_routes(self) -> None:
        ...
        self.assertIn("Closed harnessed items: 109", markdown)
        self.assertIn("Candidate items: 1", markdown)
        self.assertIn("Next recommended work: autonomous_queue_readiness_rotation_receipt_gate", markdown)
