...
class UniBotAutonomousResearchLoopTests(unittest.TestCase):
    ...
    def test_work_queue_is_small_testable_and_harnessed(self) -> None:
        ...
        self.assertEqual(loop["next_recommended_work_id"], "autonomous_queue_candidate_review_hash_rotation_gate")
        self.assertEqual(loop["receipt"]["closed_harnessed_work_items"], 108)
        ...
        self.assertEqual(
            ...
            by_id["autonomous_queue_candidate_review_hash_rotation_gate"]["allowed_files"],
        )
        self.assertIn(
        ...
        self.assertEqual(
            ...
            "autonomous_queue_candidate_review_hash_rotation_traceability",
        )
        ...
        self.assertEqual(by_id["autonomous_queue_candidate_review_hash_rotation_gate"]["status"], "candidate")
        self.assertEqual(
            by_id["autonomous_queue_candidate_review_hash_rotation_gate"]["review_gate"],
            "autonomous_queue_candidate_review_hash_rotation_traceability",
        )
        self.assertIn(
    ...
    def test_markdown_and_api_routes(self) -> None:
        ...
        self.assertIn("Closed harnessed items: 108", markdown)
        self.assertIn("Candidate items: 1", markdown)
        self.assertIn("Next recommended work: autonomous_queue_candidate_review_hash_rotation_gate", markdown)
