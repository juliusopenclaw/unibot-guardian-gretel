...
class UniBotAutonomousResearchLoopTests(unittest.TestCase):
    ...
    def test_work_queue_is_small_testable_and_harnessed(self) -> None:
        ...
        self.assertGreaterEqual(len(queue), 10)
        ...
        self.assertEqual(loop["next_recommended_work_id"], "feedback_issue_evidence_traceability")
        self.assertEqual(loop["receipt"]["closed_harnessed_work_items"], 9)
    ...
    def test_markdown_and_api_routes(self) -> None:
        ...
        self.assertIn("Closed harnessed items: 9", markdown)
        self.assertIn("Next recommended work: feedback_issue_evidence_traceability", markdown)
