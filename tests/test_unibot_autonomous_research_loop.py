...
class UniBotAutonomousResearchLoopTests(unittest.TestCase):
    ...
    def test_work_queue_is_small_testable_and_harnessed(self) -> None:
        ...
        self.assertEqual(loop["receipt"]["closed_harnessed_work_items"], 150)
        ...
        self.assertEqual(loop["candidate_rotation_receipt"]["previous_closed_commit"], "49ef7d9")
        self.assertEqual(
        ...
        self.assertEqual(
            loop["docs_traceability_negative_evidence_receipt"]["negative_evidence_receipt_commit"],
            "c2fca9a",
        )
        self.assertEqual(
            loop["docs_traceability_negative_evidence_receipt"]["negative_evidence_readiness_commit"],
            "e84d853",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            loop["docs_traceability_negative_evidence_receipt"][
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit"
            ],
            "3db59d1",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            loop["docs_traceability_negative_evidence_receipt"][
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit"
            ],
            "7667437",
        )
        self.assertEqual(
            loop["docs_traceability_negative_evidence_receipt"][
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit"
            ],
            "37077b3",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            loop["docs_traceability_negative_evidence_receipt"][
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit"
            ],
            "48b5144",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            loop["docs_traceability_negative_evidence_receipt"][
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit"
            ],
            "a6f26c3",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            by_id["autonomous_queue_candidate_rotation_receipt_gate"]["closure_evidence"]["commit"],
            "c5c9a2e",
        )
        self.assertEqual(by_id["autonomous_queue_candidate_review_hash_rotation_gate"]["status"], "closed_harnessed")
        self.assertEqual(
            by_id["autonomous_queue_candidate_review_hash_rotation_gate"]["closure_evidence"]["commit"],
            "497ac6f",
        )
        self.assertEqual(by_id["autonomous_queue_readiness_rotation_receipt_gate"]["status"], "closed_harnessed")
        self.assertEqual(
            by_id["autonomous_queue_readiness_rotation_receipt_gate"]["closure_evidence"]["commit"],
            "6e15ea5",
        )
        self.assertEqual(by_id["autonomous_queue_single_candidate_continuity_gate"]["status"], "closed_harnessed")
        self.assertEqual(
            by_id["autonomous_queue_single_candidate_continuity_gate"]["closure_evidence"]["commit"],
            "76bbddb",
        )
        self.assertEqual(by_id["autonomous_queue_continuity_readiness_gate"]["status"], "closed_harnessed")
        self.assertEqual(
            by_id["autonomous_queue_continuity_readiness_gate"]["closure_evidence"]["commit"],
            "2c18440",
        )
        self.assertEqual(by_id["autonomous_queue_continuity_docs_traceability_gate"]["status"], "closed_harnessed")
        self.assertEqual(
            by_id["autonomous_queue_continuity_docs_traceability_gate"]["closure_evidence"]["commit"],
            "6c16b88",
        )
        self.assertEqual(by_id["autonomous_queue_docs_traceability_negative_harness_gate"]["status"], "closed_harnessed")
        self.assertEqual(
            by_id["autonomous_queue_docs_traceability_negative_harness_gate"]["closure_evidence"]["commit"],
            "1f7b05d",
        )
        self.assertEqual(by_id["autonomous_queue_docs_traceability_negative_evidence_gate"]["status"], "closed_harnessed")
        self.assertEqual(
            by_id["autonomous_queue_docs_traceability_negative_evidence_gate"]["closure_evidence"]["commit"],
            "b0d9d42",
        )
        self.assertEqual(
            by_id["autonomous_queue_docs_traceability_negative_evidence_receipt_gate"]["status"],
            "closed_harnessed",
        )
        self.assertEqual(
            by_id["autonomous_queue_docs_traceability_negative_evidence_receipt_gate"]["closure_evidence"]["commit"],
            "c2fca9a",
        )
        self.assertEqual(
            by_id["autonomous_queue_docs_traceability_negative_evidence_readiness_gate"]["status"],
            "closed_harnessed",
        )
        self.assertEqual(
            by_id["autonomous_queue_docs_traceability_negative_evidence_readiness_gate"]["closure_evidence"]["commit"],
            "e84d853",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            by_id["autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_gate"][
                "status"
            ],
            "closed_harnessed",
        )
        ...
        self.assertEqual(
            by_id[previous_closed_work_id]["status"],
            "closed_harnessed",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            by_id[current_candidate_work_id]["review_gate"],
            current_candidate_review_gate,
        )
        self.assertIn(
            "unibot/autonomous_research_loop.py",
    ...
    def test_markdown_and_api_routes(self) -> None:
        ...
        self.assertIn("Closed harnessed items: 150", markdown)
        self.assertIn("Candidate items: 1", markdown)
        self.assertIn(
            "Next recommended work: autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            markdown,
        )
        self.assertIn(
