...
class UniBotAutonomousResearchLoopTests(unittest.TestCase):
    ...
    def test_work_queue_is_small_testable_and_harnessed(self) -> None:
        ...
        self.assertEqual(loop["receipt"]["closed_harnessed_work_items"], 72)
    ...
    def test_markdown_and_api_routes(self) -> None:
        ...
        self.assertIn("Closed harnessed items: 72", markdown)
        self.assertIn(
            "Next recommended work: extraction_receipt_journal_local_cycle_workspace_card_receipt_link_alignment",
            markdown,
        )
