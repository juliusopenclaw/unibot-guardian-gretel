...
class UniBotAutonomousResearchLoopTests(unittest.TestCase):
    ...
    def test_work_queue_is_small_testable_and_harnessed(self) -> None:
        ...
        self.assertEqual(loop["receipt"]["closed_harnessed_work_items"], 68)
    ...
    def test_markdown_and_api_routes(self) -> None:
        ...
        self.assertIn("Closed harnessed items: 68", markdown)
        self.assertIn(
            "Next recommended work: private_tutor_use_flow_local_cycle_workspace_card_help_ledger_link_alignment",
            markdown,
        )
