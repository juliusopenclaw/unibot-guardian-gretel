...
class UniBotAutonomousResearchLoopTests(unittest.TestCase):
    ...
    def test_work_queue_is_small_testable_and_harnessed(self) -> None:
        ...
        self.assertEqual(loop["receipt"]["closed_harnessed_work_items"], 92)
    ...
    def test_markdown_and_api_routes(self) -> None:
        ...
        self.assertIn("Closed harnessed items: 92", markdown)
        self.assertIn(
            "Next recommended work: timeline_export_review_packet_local_cycle_workspace_card_review_link_alignment",
            markdown,
        )
