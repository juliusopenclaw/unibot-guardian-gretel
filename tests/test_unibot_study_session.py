...
class UniBotStudySessionTests(unittest.TestCase):
    ...
    def test_study_session_release_claim_alignment_links_receipts_reflection_and_boundaries(self) -> None:
        ...
        self.assertTrue(alignment["workspace_card_help_ledger_hash_present"])
        self.assertTrue(alignment["workspace_card_readiness_gate_linked"])
        self.assertTrue(alignment["workspace_card_reflection_gate_linked"])
        self.assertTrue(alignment["workspace_card_reflection_hash_present"])
        ...
        self.assertTrue(alignment["contracts"]["workspace_card_reflection_gate_linked"])
