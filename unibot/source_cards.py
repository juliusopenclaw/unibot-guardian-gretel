...
SOURCE_CARDS = [
    SourceCard(
        source_id="uoc-ki-policy-2026",
        title="University of Cologne AI policy AM 2/2026",
        url="https://am.uni-koeln.de/e45267/data/records54900/AM_2026-02_KI_RL_ger.pdf",
    ...
    SourceCard(
        ...
        title="University of Cologne information on AI and examination law",
        url="https://verwaltung.uni-koeln.de/stabsstelle02.1/content/allgemeine_informationen/aktuelles/kuenstliche_intelligenz_und_pruefungsrecht/index_ger.html",
        source_kind="university-policy",
        authority_type="university-exam-office",
        product_rule="Independent AI use may be permissible when the learner's own work remains identifiable, but an exam-specific ban or permitted-aids rule takes priority; only the applicable examination rules and responsible authority decide, and UniBot cannot declare clearance.",
        risk_level="high",
        last_checked="2026-07-17",
    ),
    SourceCard(
    ...
    SourceCard(
        ...
        title="University of Cologne Medical Faculty: AI in teaching",
        url="https://medfak.uni-koeln.de/studium-lehre/ueberblick/ki-in-der-lehre",
        source_kind="university-guidance",
        authority_type="university-medical-faculty",
    ...
    SourceCard(
        ...
        title="University of Cologne Servicezentrum Inklusion: Nachteilsausgleich",
        url="https://inklusion.uni-koeln.de/informationen/nachteilsausgleich/index_ger.html",
        source_kind="university-policy",
    ...
    SourceCard(
        ...
        title="University of Cologne Servicezentrum Inklusion: exam support",
        url="https://inklusion.uni-koeln.de/service/klausurunterstuetzung/index_ger.html",
        source_kind="university-policy",
        authority_type="university-inclusion-process",
        product_rule="The Servicezentrum Inklusion supports teaching and examination offices with rooms, assistive technology, equipment, and personnel; requests are normally coordinated in advance. UniBot cannot decide or implement an accommodation and does not replace this institutional route.",
        risk_level="high",
        last_checked="2026-07-17",
    ),
    SourceCard(
        source_id="uoc-szi-assistenzstelle-2026",
        title="University of Cologne Servicezentrum Inklusion: Assistenzstelle",
        url="https://inklusion.uni-koeln.de/service/assistenzstelle/index_ger.html",
        source_kind="university-guidance",
        authority_type="university-inclusion-process",
        product_rule="The Assistenzstelle can route students to inclusion counselling, study assistance, and exam support; UniBot may point to this institutional route but cannot infer need or decide an accommodation.",
        risk_level="high",
        last_checked="2026-07-17",
    ),
    SourceCard(
        source_id="uoc-szi-inclusive-teaching-2026",
        title="University of Cologne Servicezentrum Inklusion: inclusive teaching guidance",
        url="https://inklusion.uni-koeln.de/informationen/inklusive_lehre/schritte_inklusive_lehre/index_ger.html",
        source_kind="university-guidance",
        authority_type="university-inclusion-process",
        product_rule="Accessibility needs should be addressed early and without accidental disclosure; UniBot provides an accessible fallback, not an inclusion decision.",
        risk_level="high",
        last_checked="2026-07-16",
    ),
    SourceCard(
        source_id="uoc-szi-wegweiser-2026",
        title="University of Cologne Servicezentrum Inklusion: disability and accessibility guide",
        url="https://inklusion.uni-koeln.de/wegweiser/index_ger.html",
        source_kind="university-guidance",
        authority_type="university-inclusion-process",
        product_rule="Support and accommodation routes are individual and institution-led; UniBot must not infer or decide a learner's accommodation.",
        risk_level="high",
        last_checked="2026-07-16",
    ),
    SourceCard(
        ...
        source_kind="technical-standard",
        authority_type="w3c-standard",
        product_rule="Use WCAG 2.2 AA as a human review target for the browser surface; automated checks never certify conformance.",
        risk_level="high",
        last_checked="2026-07-16",
    ),
    SourceCard(
        source_id="bgg-nrw-10",
        title="Behindertengleichstellungsgesetz Nordrhein-Westfalen section 10",
        url="https://recht.nrw.de/lmi/owa/br_bes_detail?anw_nr=2&aufgehoben=N&bes_id=5216&det_id=428912",
        source_kind="law",
        authority_type="state-law",
        product_rule="The institution must determine the applicable public-service accessibility scope; UniBot cannot self-declare legal compliance.",
        risk_level="high",
        last_checked="2026-07-16",
    ),
    SourceCard(
        ...
        url="https://recht.nrw.de/lmi/owa/br_bes_text?anw_nr=2&aufgehoben=N&bes_id=40725&gld_nr=+2&keyword=&menu=1&sg=2&show_preview=1&typ=Kopf&ugl_nr=201&val=40725&ver=0",
        source_kind="regulation",
        authority_type="state-regulation",
        product_rule="Use BITV NRW as the institutional review context where applicable; a real conformance assessment remains a human and scope-bound gate.",
        risk_level="high",
        last_checked="2026-07-16",
    ),
    SourceCard(
