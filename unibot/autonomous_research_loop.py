...
def build_autonomous_docs_traceability_negative_evidence_receipt(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    docs_traceability_tail_148_commit_key = (
    ...
    contracts = {
        ...
        == "a6f26c3",
        "current_candidate_is_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt": selected_work_id
        ...
        "current_review_gate_is_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt": review_gate
        == "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
        "candidate_receipt_ready": candidate_receipt.get("status") == "candidate_receipt_ready",
        "candidate_not_auto_runnable": candidate_receipt.get("candidate_is_not_auto_ready") is True
        and candidate_receipt.get("auto_promotion_allowed") is False,
        "single_candidate_lane_preserved": len([item for item in queue if item.get("status") == "candidate"]) == 1,
