...
def build_autonomous_work_queue() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "closure_evidence": {
                "commit": "c2fca9a",
                "summary": "UniBot autonomous loop now carries a docs-traceability negative-evidence receipt with hash linkage, closure-commit checks, no external effects, and a negative harness for missing closure evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_gate",
            "priority": 117,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability negative-evidence receipt in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness",
            "closure_evidence": {
                "commit": "e84d853",
                "summary": "UniBot readiness now gates and surfaces the docs-traceability negative-evidence receipt status, commit chain, selected work id, review gate, failed-contract list, auto-promotion block, and loop-hash match.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_gate",
            "priority": 118,
            "status": "closed_harnessed",
            "goal": "Add a negative harness proving the readiness gate blocks a missing or mismatched docs-traceability negative-evidence receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative",
            "closure_evidence": {
                "commit": "f5bb021",
                "summary": "UniBot readiness now has a negative harness proving a missing docs-traceability negative-evidence receipt or mismatched receipt hash blocks the autonomous-loop readiness check.",
            },
        },
        {
        ...
        },
        {
            ...
            "closure_evidence": {
                "commit": "57d649c",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt closure chain and blocks green readiness when the tail commit evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_gate",
            "priority": 121,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt readiness closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "60ba49e",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt readiness closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_gate",
            "priority": 122,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "883b80e",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt-readiness receipt closure and blocks green readiness when that receipt visibility commit is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 123,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "468358c",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 124,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "35d7de0",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt closure and blocks green readiness when either tail visibility commit is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 125,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "536a5ae",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 126,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "06d9c48",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt closure and blocks green readiness when either tail receipt-readiness commit is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 127,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "3a15aad",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 128,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "ef199b2",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt closure and blocks green readiness when either final receipt-tail commit is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 129,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "f31c122",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 130,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "a7775da",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt closure and blocks green readiness when the final receipt-tail commit is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 131,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "0d98bc5",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 132,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "3e43a9a",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt closure and blocks green readiness when the final receipt-readiness tail commit is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 133,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "a95536a",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 134,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "47305cd",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt closure and blocks green readiness when the final receipt-binding tail commit is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 135,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "ba2684d",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt readiness closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 136,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "32d10f8",
                "summary": "UniBot readiness now surfaces the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding closure and blocks green readiness when the final receipt-binding readiness tail commit is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 137,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "f01d737",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding readiness closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 138,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "3db59d1",
                "summary": "UniBot readiness now surfaces f01d737 as the docs-traceability receipt-binding receipt tail and blocks green readiness when that tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 139,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "2e60207",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 140,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "d36dbfd",
                "summary": "UniBot readiness now surfaces 2e60207 as the docs-traceability receipt-binding receipt-readiness tail and blocks green readiness when that tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 141,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "f966650",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 142,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "7667437",
                "summary": "UniBot readiness now surfaces f966650 as the docs-traceability receipt-binding receipt-readiness receipt tail and blocks green readiness when that tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 143,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "37077b3",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 144,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "8fab4a0",
                "summary": "UniBot readiness now surfaces 37077b3 as the docs-traceability receipt-binding receipt-readiness receipt tail and blocks green readiness when that tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 145,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "00fb3d9",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 146,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "48b5144",
                "summary": "UniBot readiness now surfaces 00fb3d9 as the docs-traceability receipt-binding receipt-readiness receipt receipt tail and blocks green readiness when that tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 147,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "52f4ec8",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 148,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "a6f26c3",
                "summary": "UniBot readiness now surfaces 52f4ec8 as the docs-traceability receipt-binding receipt-readiness receipt receipt receipt tail and blocks green readiness when that tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 149,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "180d5c5",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 150,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "49ef7d9",
                "summary": "UniBot readiness now surfaces 180d5c5 as the docs-traceability receipt-binding receipt-readiness receipt receipt receipt receipt tail and blocks green readiness when that tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 151,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "2105ec7",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 152,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "6677b7a",
                "summary": "UniBot readiness now surfaces 49ef7d9 and 2105ec7 as docs-traceability receipt-binding readiness-tail evidence and blocks green readiness when the current tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 153,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "754a13b",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 154,
            "status": "closed_harnessed",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
            "closure_evidence": {
                "commit": "a40892b",
                "summary": "UniBot readiness now surfaces 6677b7a and 754a13b as docs-traceability receipt-binding readiness-tail evidence and blocks green readiness when the current tail evidence is missing.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
            "priority": 155,
            "status": "closed_harnessed",
            "goal": "Bind the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt receipt receipt closure into the autonomous-loop receipt while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/autonomous_research_loop.py",
                "tests/test_unibot_autonomous_research_loop.py",
                "tests/test_unibot_readiness.py",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt",
            "closure_evidence": {
                "commit": "22ee3a3",
                "summary": "The autonomous-loop receipt now binds the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt receipt receipt closure into the negative-evidence receipt and loop hash evidence.",
            },
        },
        {
            "work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
            "priority": 156,
            "status": "candidate",
            "goal": "Surface the docs-traceability readiness-negative-receipt-readiness receipt visibility receipt readiness receipt receipt receipt receipt receipt receipt-binding receipt readiness receipt receipt receipt receipt receipt receipt receipt receipt receipt closure in readiness evidence while preserving zero ready work items, one public-safe candidate, bounded file scope, no provider call, no autonomous publication, no exam clearance claim, no grading/proctoring/KI-detection, and no private context ingestion.",
            "allowed_files": [
                "unibot/readiness.py",
                "tests/test_unibot_readiness.py",
                "docs/unibot/UNIBOT_READINESS_CHECK.md",
            ...
            "review_gate": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness",
        },
    ]
...
def build_autonomous_docs_traceability_negative_evidence_receipt(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    negative_evidence_receipt = by_id.get("autonomous_queue_docs_traceability_negative_evidence_receipt_gate", {})
    negative_evidence_readiness = by_id.get("autonomous_queue_docs_traceability_negative_evidence_readiness_gate", {})
    ...
    negative_evidence_readiness_negative_receipt_readiness = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_gate", {}
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_gate", {}
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt = by_id.get(
    ...
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness = by_id.get(
    ...
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness = by_id.get(
    ...
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt = by_id.get(
    ...
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
        {},
    )
    negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness = by_id.get(
        "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        {},
    )
    candidate_receipt = payload.get("candidate_receipt", {})
    candidate_receipt = candidate_receipt if isinstance(candidate_receipt, dict) else {}
    docs_traceability_tail_prefix = "autonomous_queue_docs_traceability_"
    docs_traceability_tail_commits = {
        str(item.get("work_id", ""))
        .removeprefix(docs_traceability_tail_prefix)
        .removesuffix("_gate")
        + "_commit": str(item.get("closure_evidence", {}).get("commit", ""))
        for item in queue
        if str(item.get("work_id", "")).startswith(docs_traceability_tail_prefix)
        and item.get("status") == "closed_harnessed"
        and str(item.get("closure_evidence", {}).get("commit", "")) != ""
    }
    docs_traceability_tail_155_commit_key = (
    ...
    contracts = {
        ...
        "negative_evidence_receipt_closed": negative_evidence_receipt.get("status") == "closed_harnessed"
        and str(negative_evidence_receipt.get("closure_evidence", {}).get("commit", "")) != "",
        "negative_evidence_readiness_closed": negative_evidence_readiness.get("status") == "closed_harnessed"
        and str(negative_evidence_readiness.get("closure_evidence", {}).get("commit", "")) != "",
        ...
        "negative_evidence_readiness_negative_receipt_readiness_closed": negative_evidence_readiness_negative_receipt_readiness.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness.get("closure_evidence", {}).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_closed": negative_evidence_readiness_negative_receipt_readiness_receipt.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt.get("closure_evidence", {}).get(
                "commit", ""
            )
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness.get("closure_evidence", {}).get(
                "commit", ""
            )
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_closed": negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
            "status"
        )
        == "closed_harnessed"
        and str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        )
        != "",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit_bound": docs_traceability_tail_commits.get(
            docs_traceability_tail_155_commit_key
        )
        == "22ee3a3",
        "current_candidate_is_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness": selected_work_id
        ...
        "current_review_gate_is_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness": review_gate
    ...
    receipt = {
        ...
        "negative_evidence_receipt_work_id": "autonomous_queue_docs_traceability_negative_evidence_receipt_gate",
        "negative_evidence_receipt_commit": str(
            negative_evidence_receipt.get("closure_evidence", {}).get("commit", "")
        ),
        "negative_evidence_readiness_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_gate",
        "negative_evidence_readiness_commit": str(
            negative_evidence_readiness.get("closure_evidence", {}).get("commit", "")
        ),
        ...
        "negative_evidence_readiness_negative_receipt_readiness_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_gate",
        "negative_evidence_readiness_negative_receipt_readiness_commit": str(
            negative_evidence_readiness_negative_receipt_readiness.get("closure_evidence", {}).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt.get("closure_evidence", {}).get(
                "commit", ""
            )
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness.get("closure_evidence", {}).get(
                "commit", ""
            )
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id": "autonomous_queue_docs_traceability_negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_gate",
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": str(
            negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt.get(
                "closure_evidence", {}
            ).get("commit", "")
        ),
        ...
        json.dumps(
            {
                ...
                "negative_evidence_receipt_work_id": receipt["negative_evidence_receipt_work_id"],
                "negative_evidence_receipt_commit": receipt["negative_evidence_receipt_commit"],
                "negative_evidence_readiness_work_id": receipt["negative_evidence_readiness_work_id"],
                "negative_evidence_readiness_commit": receipt["negative_evidence_readiness_commit"],
                "negative_evidence_readiness_negative_work_id": receipt[
                    "negative_evidence_readiness_negative_work_id"
                ],
                ...
                "negative_evidence_readiness_negative_receipt_readiness_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": receipt[
                ...
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit": receipt[
                ...
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": receipt[
                ...
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_work_id"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": receipt[
                ...
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": receipt[
                ...
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit": receipt[
                    "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_commit"
                ],
                "negative_evidence_readiness_negative_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_readiness_receipt_commit": receipt[
                ...
                "docs_traceability_tail_commits": docs_traceability_tail_commits,
                "selected_work_id": receipt["selected_work_id"],
                "selected_status": receipt["selected_status"],
                "review_gate": receipt["review_gate"],
                "candidate_receipt_hash": receipt["candidate_receipt_hash"],
