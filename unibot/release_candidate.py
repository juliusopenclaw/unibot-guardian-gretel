...
def _review_start_here_markdown(source_commit: str) -> str:
    return "\n".join(
        [
            ...
            "",
            "## 15-Minuten-Demo; vollständige Review etwa 25 Minuten",
            "",
            "Die 15 Minuten sind nur der kurze Produkt-Demo-Teil. Für die vollständige rollenbezogene Prüfung sind etwa 25 Minuten vorgesehen.",
            "",
            "1. Öffne `PUBLIC-DEMO.md` und verwende ausschließlich `synthetic_python_practice.ipynb`.",
            "2. Bestätige im Panel ausdrücklich: freiwillige Übung, kein Prüfungseinsatz (`practice_only`). Ohne diese Bestätigung startet der Companion nicht.",
            "3. Zeige im Chrome-Seitenpanel die Auswahl einer synthetischen Zelle und die Hilfe A0 bis A4.",
            "4. Zeige, dass der Tutor keine fertige Lösung, keinen Endwert und keinen ausgeführten Notebookcode liefert.",
            "5. Öffne danach den `institutional-plain-language-brief.md` und den `institutional-accessibility-walkthrough.md`.",
            "6. Nutze `review-board-packet.md` für die rollenbezogenen Fragen; die JSON-Fassung dient der nachvollziehbaren Prüfungskette.",
            "",
            ...
            "Jede Lernsession verlangt vor dem Start die sichtbare Grenze `practice_only`: freiwillige Übung, kein Prüfungseinsatz.",
            "",
