...
def build_public_demo_evidence() -> dict[str, Any]:
    ...
    report = {
        ...
        "human_demo_gates": [
            ...
            "show_optional_accessibility_display_mode",
...
def build_public_demo_markdown(report: dict[str, Any] | None = None) -> str:
    ...
    lines = [
        ...
        "5. Die barrierearme Darstellung einschalten; groessere Bedienelemente und Abstaende zeigen und die Kostenneutralitaet erklaeren.",
        "6. Mit den zustaendigen Stellen Zweck, Barrierefreiheit, Datenschutz und Grenzen besprechen.",
        "7. Eine synthetische fertige Antwort einspeisen; der Guardian blockiert sie und zeigt nur eine Rueckfrage.",
        "",
        "## Grenze",
        "",
