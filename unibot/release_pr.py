    ...
    *,
    ...
    body = "\n".join(
        [
            ...
            "Die optionale barrierearme Darstellung aktiviert lokal größere Bedienelemente sowie mehr Zeilen- und Textabstand; sie ist kostenneutral, freiwillig und keine Diagnose oder automatische Unterstützungsentscheidung. Ihre Nutzung wird weder im Sitzungsjournal noch im Export protokolliert.",
